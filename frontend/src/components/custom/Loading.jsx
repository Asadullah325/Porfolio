...
import '@/css/Loading.css'; // Assuming you have a CSS file for loading styles

const Loading = () => {
    return (
        <>
            <div class="loading flex items-center justify-center h-screen bg-gradient-to-r from-[#e0c8f2] to-[#e9b3d8] 
